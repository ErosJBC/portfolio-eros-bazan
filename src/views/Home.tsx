    ...
    <>
      <section id='home' className='bg-zinc-900 pt-28'>
        <div className='max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 pb-16'>
          <div className='mx-auto my-auto px-14 md:px-12'>
            ...
            <p className='leading-relaxed py-4 text-neutral-50 text-justify'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit, quos quibusdam! Ut amet velit assumenda quasi repudiandae accusamus quas iusto, cupiditate consectetur officia ea perspiciatis neque necessitatibus cumque voluptatibus consequuntur.</p>
            <div className='pt-5'>
          ...
          <div className='mx-auto my-auto pt-16 md:pt-0 px-14 md:pl-2 md:pr-12'>
